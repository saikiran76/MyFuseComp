      ...
      <div className="flex flex-col justify-center text-white bg-neutral-700">
        <div className="flex flex-col justify-center w-full bg-zinc-50 max-md:max-w-full">
          <div className="flex overflow-hidden relative flex-col justify-center items-start px-14 py-12 w-full min-h-[430px] max-md:px-5 max-md:max-w-full">
            ...
            />
            <div className="flex overflow-hidden relative flex-col items-start py-16 pr-20 pl-9 max-w-full backdrop-filter backdrop-blur-none min-h-[335px] w-[900px] max-md:px-5">
              <img
                loading="lazy"
              ...
              />
              <div className="relative mt-5 text-4xl font-extrabold text-yellow-300 max-md:max-w-full">
              ...
              <div className="btn-1 justify-center p-4 mt-12 text-xl bg-red-600 text-white rounded-md transition duration-300 hover:bg-lime-500 text-center cursor-pointer backdrop-filter-none" style={{ backdropFilter: 'none' }}>
                    Read more
                </div>
            </div>
